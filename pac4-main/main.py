...
print("\tEl patro 'Huffington Post' apareix %s vegades. Mentre que hi ha un total de %s urls en format pfd.\n" %
      (recompte_sponsor))

##1.2
print("\t1.2")
recompte_sponsor_lbl = count_sponsor_lbl('Huffington Post')
print("\tEl patro 'Huffington Post' apareix %s vegades\n" % (recompte_sponsor_lbl))
...
#Creacio approval_polls i concern_polls
...
print("\tapproval_polls te una llargada de %s files\n" % (len(approval_polls)))

concern_polls = preparacio_ex2(df, df2)
print("\tconcern_polls te una llargada de %s files\n" % (len(concern_polls)))
...
print("\tLa grafica tambe s'ha guardat a la carpeta directori amb el nom 'plotex3'. Quan es tanqui la finestra de la\n"
      "\tgrafica, seguira l'execucio del programa i apareixera la taula amb els valors exactes de la imatge.\n")
...
print("\t4.2")
print("\tLa grafica tambe s'ha guardat a la carpeta directori amb el nom 'plotex42'. Quan es tanqui la finestra de la\n"
      "\tgrafica, seguira l'execucio del programa i apareixern els valors exactes.\n")
...
print("\t4.3\n")
print("\tLa grafica tambe s'ha guardat a la carpeta directori amb el nom 'plotex43'. Quan es tanqui la finestra de la\n"
      "\tgrafica, seguira l'execucio del programa i apareixern els valors exactes.\n")
...
print("\t4.4\n")
print("\tLa grafica tambe s'ha guardat a la carpeta directori amb el nom 'plotex44'. Quan es tanqui la finestra de la\n"
      "\tgrafica, seguira l'execucio del programa i apareixern els valors exactes de l'exercici.\n")
...
print("\tPer preparar l'exercici, fem els canvis demanats i afegim la variable 'puntuacio' a l'arxiu 'concern_polls'\n"
      "i guardant aquells registres amb una puntuacio >= 1.5.\n")
ex5prep = nota_numerica(ex_41)
columna = puntuacio(ex5prep)
mes_gran = puntuacio_mes_gran_que(columna)
print("\nLa nova llista de columnes per l'arxiiu 'concern_polls' es la seguent:\n")
print(concern_polls.columns)

##5.1

print("\t5.1\n")
print("\tLa grafica tambe s'ha guardat a la carpeta directori amb el nom 'plotex51'. Quan es tanqui la finestra de la\n"
      "\tgrafica (on False es abans i True es despres), seguira l'execucio del programa i apareixern els valors exactes\n"
      "de l'exercici.\n")
abans_o_despres = columna_abans_o_despres(mes_gran)
print("\t Nombre de persones entrevistades per nivell de preocupacio i en funcio de la data:\n")
print("\t False = Abans / True = Despres:\n")
...
print("\t5.2\n")
print("\tLa grafica tambe s'ha guardat a la carpeta directori amb el nom 'plotex52'. Quan es tanqui la finestra de la\n"
      "\tgrafica (on False es abans i True es despres), seguira l'execucio del programa i apareixern els valors exactes\n"
      "\tde l'exercici.\n")
perc_abans_o_despres = columna_percentatge_abans_o_despres(mes_gran)
print("\t Percentatge de persones entrevistades per nivell de preocupacio i en funcio de la data:\n")
print("\t False = Abans / True = Despres:\n")
