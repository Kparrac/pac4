...
def count_sponsor(sponsor):
    """ Funció que troba una cadena a la columna 'sponsor' del csv 'covid_approval_polls.csv'.
...
def count_sponsor_lbl(sponsor):
    """ Funció que troba una cadena a la columna 'sponsor' del csv 'covid_approval_polls.csv'.
        L'arxiu es llegeix línia a línia.
...
def create_df_from_csv(csvfile):
    """ Funció que crea un dataframe des de un arxiu csv.
...
def create_df_from_xlxs(xlxsfile):
    """Funció que crea un dataframe des de un arxiu xlsx.
...
def preparacio_ex2(df1, df2):
    """Funció que fa un join de dos dataframes en la columna 'pollster'.
...
def grafica_ex3(df):
    """Funció que guarda i mostra una gràfica de 'df.groupby'.
...
def arreglar_notes(df):
    """Funció que substitueix valors de la columna '538 Grade' per la nota entera o més baixa.
...
def nota_numerica(df):
    """Funció que crea una nova columna i substitueix valors de la columna '538 Grade' per un equivalent
       numèric.
...
def puntuacio(df):
    """Funció que crea una nova columna resultant de dues altres columnes del mateix dataframe
...
def puntuacio_mes_gran_que(df):
    """Funció que aplica un filtre a un dataframe.
...
def columna_abans_o_despres(df):
    """Funció que guarda i mostra una gràfica de 'df.groupby' i retorna un dataframe amb resultats agregats.
